package com.kago.vpnapp.widgets
...
import com.kago.vpnapp.GlobalState
import com.kago.vpnapp.R
import com.kago.vpnapp.RunState
...
class ModeWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.kago.vpnapp.widget.ACTION_TOGGLE"
        const val ACTION_MODE_RULE = "com.kago.vpnapp.widget.ACTION_MODE_RULE"
        const val ACTION_MODE_GLOBAL = "com.kago.vpnapp.widget.ACTION_MODE_GLOBAL"
        const val ACTION_MODE_DIRECT = "com.kago.vpnapp.widget.ACTION_MODE_DIRECT"
        ...
        private fun refreshAll() {
            val ctx = com.kago.vpnapp.FlClashXApplication.getAppContext() ?: return
