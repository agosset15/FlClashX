package com.kago.vpnapp.plugins
...
import com.kago.vpnapp.Service
import com.kago.vpnapp.common.Components
...
import com.kago.vpnapp.service.models.gsonSanitized
...
class ServicePlugin :
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "saveParams" -> {
                ...
                com.kago.vpnapp.common.SavedParams.saveQuickStartParams(init, params, state)
                result.successOnMain(true)
            }
    ...
    private fun handleShowSubscriptionNotification(call: MethodCall, result: MethodChannel.Result) {
        ...
        val builder = NotificationCompat.Builder(ctx, GlobalState.SUBSCRIPTION_NOTIFICATION_CHANNEL)
            .setSmallIcon(com.kago.vpnapp.service.R.drawable.ic_notification)
