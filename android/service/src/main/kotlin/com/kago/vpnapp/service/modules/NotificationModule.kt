package com.kago.vpnapp.service.modules
...
import com.kago.vpnapp.common.buildServiceNotification
import com.kago.vpnapp.common.startForeground
import com.kago.vpnapp.service.Module
import com.kago.vpnapp.service.State
...
class NotificationModule(service: Service) : Module(service) {
    ...
    private fun ensureChannel() {
        ...
        val channel = NotificationChannel(
            ...
            service.getString(com.kago.vpnapp.common.R.string.notification_channel_name),
    ...
    private fun buildNotification(title: String, stopText: String = ""): android.app.Notification {
        return service.buildServiceNotification(
            com.kago.vpnapp.service.R.drawable.ic_notification,
            title,
            stopText,
        )
    }
