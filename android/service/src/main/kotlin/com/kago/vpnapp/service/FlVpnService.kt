...
import com.kago.vpnapp.service.models.toCIDR
import com.kago.vpnapp.service.modules.HealthCheckModule
...
class FlVpnService : VpnService(), IBaseService {
    ...
    companion object {
        const val ACTION_STOP = "com.kago.vpnapp.service.STOP"
    }
    ...
    private suspend fun coldStart() {
        State.runLock.withLock {
            ...
            if (coreResult == null) {
                ...
                runCatching { com.kago.vpnapp.core.Core.stopTun() }
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                    stopForeground(STOP_FOREGROUND_REMOVE)
                } else {
                    @Suppress("DEPRECATION")
    ...
    override suspend fun handleStart(options: VpnOptions) {
        ...
        runCatching {
            ...
            if (ac != null) {
                when (ac.mode) {
                    com.kago.vpnapp.common.AccessControlMode.acceptSelected ->
                        allInclude.addAll(ac.acceptList)
                    com.kago.vpnapp.common.AccessControlMode.rejectSelected ->
        ...
        try {
            ...
            val started = com.kago.vpnapp.core.Core.startTun(
                fd = fd,
